...
| U-03 | Tasti premuti in Advanced/Settings agivano sul grafico principale | [FATTO passo #16] il filtro centrale per `windowID` blocca testo e tasti secondari prima dei controlli principali; Cmd/Ctrl+F e Cmd/Ctrl+B restano globali. |
