#!/usr/bin/env python3
"""Synthetic Pickett .cat fixtures for tests/test_audit.c.

Derived from docs/audit/repro/gen_fixtures.py.  Usage:

    gen_fixtures.py <output folder> <reference pred.cat>
